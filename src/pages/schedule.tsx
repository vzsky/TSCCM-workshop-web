...
const scheduleItems: ScheduleItem[] = [
  ...
  },
  {
    ...
    speaker: 'Assoc. Prof. Anupol Panitchote, MD (Khon Kaen University), Asst. Prof. Sitthichok Chaichulee (Prince of Songkla University), Preut Assawaworrarit, MD (Chulalongkorn University), and Assoc. Prof. Tanuwong Viarasilpa, MD (Siriraj Hospital, Mahidol University)'
  },
  {
    time: '14:00',
...
const ScheduleItem = ({ time, title, speaker }: ScheduleItem) => (
  <Box py={4}>
    <HStack gap={8} alignItems="start">
      <Text fontWeight="bold" minW="80px">{time}</Text>
      <VStack alignItems="start" gap={1}>
        <Text fontWeight="medium">{title}</Text>
        {speaker && <Text fontSize="sm" color="gray.600">{speaker}</Text>}
      </VStack>
    </HStack>
  </Box>
);
        ...
        <VStack gap={12} alignItems="stretch">
          ...
          <VStack gap={6} alignItems="center" textAlign="center">
            ...
            <Text fontSize="xl" color="gray.600" maxW="2xl">
              Join us for a day of insightful discussions and presentations on Data Warehouse and AI in Intensive Care Medicine
            </Text>
          </VStack>
          ...
          <InfoSection title="Description">
            <Text>
              Join our <em>Data Warehouse and AI in Intensive Care Medicine</em>, a special workshop hosted as a part of the 14th Critical Care Conference in Thailand, at the Bhumisiri Mangkhalanusorn Building, Chulalongkorn Hospital in Bangkok.
            </Text>
            <Text mt={4}>
              Reflecting on this year's theme, "Together in Critical Care," we will delve into the roles of AI and technology towards critical care. Our goal is to foster meaningful discussions, share cutting-edge knowledge, and explore innovative practices that improve patient outcomes using advanced technology in the AI era.
            </Text>
            <Text mt={4}>
          ...
          <InfoSection title="Event Highlights">
            <VStack alignItems="start" gap={4}>
              <Box>
                ...
                <Text>Spend two hours on the basics of technology behind artificial intelligence and large language models. The topics also cover the biases and vulnerabilities of these AI systems and how to mitigate them.</Text>
              </Box>
              <Box>
                <Text fontWeight="bold">Research, Education, and Policy Development in AI Era</Text>
                <Text>Brainstorm and exchange ideas on integrating safe and inclusive AI-human systems in the context of teaching and managing critical care.</Text>
              </Box>
              <Box>
                <Text fontWeight="bold">Success Stories</Text>
                <Text>Listen to smart ICU initiatives from frontier hospitals all over Thailand and cutting-edge solutions from partnered companies.</Text>
              </Box>
            </VStack>
          </InfoSection>
          ...
          {/* Schedule Section */}
          <Box>
            <Heading size="lg" mb={6}>Schedule</Heading>
